...
class DetailNiatMaghribPage extends StatelessWidget {
  const DetailNiatMaghribPage({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ' أُصَلِّيَ فَرْضَ الْمَغْرِبِ ثَلَاثَ رَكْعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ أَدَاءً لِلّٰهِ تَعَالَى',
                  textAlign: TextAlign.center,
