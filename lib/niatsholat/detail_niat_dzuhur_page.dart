...
class DetailNiatDzuhurPage extends StatelessWidget {
  const DetailNiatDzuhurPage({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ' أُصَلِّيَ فَرْضَ الظُّهْرِ أَرْبَعَ رَكْعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ أَدَاءً لِلّٰهِ تَعَالَى',
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 30, fontFamily: 'Scheherazade', color: Colors.black87, height: 2.2),
                ),
                const SizedBox(height: 40),
                const Text(
                  'Ushalli fardhazh zhuhri arba‘a raka‘ātin mustaqbilal qiblati adā’an lillāhi ta‘ālā.',
                  textAlign: TextAlign.center,
