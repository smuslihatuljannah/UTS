...
class DetailNiatIsyaPage extends StatelessWidget {
  const DetailNiatIsyaPage({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ' أُصَلِّيَ فَرْضَ الْعِشَاءِ أَرْبَعَ رَكْعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ أَدَاءً لِلّٰهِ تَعَالَى',
                  textAlign: TextAlign.center,
